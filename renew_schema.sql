...
CREATE TABLE ADMINS (
	N_USER_ID SERIAL			PRIMARY KEY REFERENCES USERS (N_USER_ID), 
...
INSERT INTO PARAMETERS(VC_PARAMETER_CODE, VC_VALUE) VALUES ('rules', 'Это правила игры, в которую я хочу сыграть с тобой');
INSERT INTO PARAMETERS(VC_PARAMETER_CODE, VC_VALUE) VALUES ('about', 'Это авторы игры, в которую я хочу сыграть с тобой');
