...
class ParametersControllerTest < ActionController::TestCase
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post :create, parameter: { errors: @parameter.errors, prices: @parameter.prices, stats: @parameter.stats, steps: @parameter.steps, true_answers: @parameter.true_answers }
    end
  ...
  test "should update parameter" do
    put :update, id: @parameter, parameter: { errors: @parameter.errors, prices: @parameter.prices, stats: @parameter.stats, steps: @parameter.steps, true_answers: @parameter.true_answers }
    assert_redirected_to parameter_path(assigns(:parameter))
  end
