...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { stats: @price.stats, steps: @price.steps, true_answers: @price.true_answers }
    end
  ...
  test "should update price" do
    put :update, id: @price, price: { stats: @price.stats, steps: @price.steps, true_answers: @price.true_answers }
    assert_redirected_to price_path(assigns(:price))
  end
