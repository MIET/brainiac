...
class ErrorsControllerTest < ActionController::TestCase
  ...
  test "should create error" do
    assert_difference('Error.count') do
      post :create, error: { prices: @error.prices, stats: @error.stats, steps: @error.steps, true_answers: @error.true_answers }
    end
  ...
  test "should update error" do
    put :update, id: @error, error: { prices: @error.prices, stats: @error.stats, steps: @error.steps, true_answers: @error.true_answers }
    assert_redirected_to error_path(assigns(:error))
  end
